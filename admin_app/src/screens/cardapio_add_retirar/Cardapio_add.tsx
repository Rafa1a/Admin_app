...
import { fetchadicionar_cardapio, fetchatualizar_cardapio_imagem } from '../../store/action/cardapio';
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View>
                ...
                <View style={{flexDirection:'row',justifyContent:'space-between',margin:10}}>
                    ...
                    {categoria==='bebidas'?
                    <>
                        <TouchableOpacity style={[{backgroundColor:'#fff',padding:10,marginBottom:10,borderRadius:5},categoria_2==='no_alcool'?{borderColor:'#E81000',borderWidth:3,}:null]} onPress={() => setCategoria_2('no_alcool')}>
                            <Text style={{fontFamily:'OpenSans-Bold',color:'#000',fontSize:19}}>no_alcool</Text>
                        </TouchableOpacity>
